...
var EXPORTED_SYMBOLS = ["registerObserver", "unregisterObserver", "submitReport", 
    "ACR_RPC_EVENT_TYPE_SUBMIT_REPORT_COMPLETE", "init"];
...
const ACR_RPC_EVENT_TYPE_SUBMIT_REPORT_COMPLETE  = 100;
...
function submitReport(guid, addonVersion, worksProperly, appGUID, appVersion, appBuild, clientOS, comments, otherAddons, callback)
{
